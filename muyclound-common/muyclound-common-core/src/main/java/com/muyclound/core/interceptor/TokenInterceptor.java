...
import com.muyclound.annotation.NoNeedAccessAuthentication;
...
public class TokenInterceptor implements HandlerInterceptor {
  ...
  @Value("${muyclound.oauth2.jwtSigningKey}")
  ...
  public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) {
    ...
    String key = RedisUtil.format("muyclound:token:accessToken:%s", token);
    String user = redisService.getKey(key);
